...
**Option 1 — Install with `apt install`:**

First, add the repository to your system (this only needs to be done once):
```bash
...
Future updates can be installed with `sudo apt update && sudo apt upgrade`.
